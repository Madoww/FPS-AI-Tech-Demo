...
public class FmodProgrammerInstruments : MonoBehaviour
{
    ...
    //    eventInstance.getUserData(out IntPtr stringPtr);
    //    
    ...
    {
        var dialogueInstance = FMODUnity.RuntimeManager.CreateInstance(eventReference);
